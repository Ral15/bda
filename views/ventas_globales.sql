...
AS SELECT E7SUCURSAL.NOMBRE AS SUCURSAL, E7EMPLEADO.NOMBRE, E7EMPLEADO.APELLIDO, SUM(E7VENTA.MONTO) AS TOTAL FROM E7VENTA, E7EMPLEADO, E7SUCURSAL
...
UNION
SELECT E7SUCURSAL.NOMBRE AS SUCURSAL, E7EMPLEADO.NOMBRE, E7EMPLEADO.APELLIDO, SUM(E7VENTA.MONTO) AS TOTAL FROM E7VENTA@CDMX, E7EMPLEADO@CDMX, E7SUCURSAL@CDMX
WHERE E7VENTA.EMPLEADO_ID = E7EMPLEADO.ID AND E7VENTA.SUCURSAL_ID = E7SUCURSAL.ID
GROUP BY E7SUCURSAL.NOMBRE, E7EMPLEADO.NOMBRE, E7EMPLEADO.APELLIDO
UNION
